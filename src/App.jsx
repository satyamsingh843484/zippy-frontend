...
function Footer() {
  return (
    <footer className="w-full bg-[#f4f6fb] pt-12 pb-8 mt-4 border-t border-gray-100">
      {/* Container - Left aligned as per your style */}
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
          ...
          <div className="space-y-3">
            <h1 
              className="text-[48px] md:text-[64px] font-black tracking-[-0.06em] text-[#b0b3b8] leading-none mb-1 lowercase" 
          ...
          <div className="space-y-3">
            <h3 className="text-[12px] font-semibold text-[#b0b3b8] uppercase tracking-[0.1em]">
              Quick Links
            </h3>
            <ul className="space-y-2">
              {['Home', 'Menu', 'Offers', 'Contact'].map((item) => (
                <li key={item}>
                  <a 
                    href="#" 
                    className="text-[15px] text-[#7a8089] hover:text-[#005af0] transition-all duration-300 hover:translate-x-1 inline-block"
                    style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}
                  >
                    {item}
                  </a>
          ...
          <div className="space-y-4">
            ...
            {/* Social Icons - Professional SVG Icons */}
            <div className="flex gap-4">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-[#e8ebf0] flex items-center justify-center text-[#7a8089] hover:bg-[#005af0] hover:text-white transition-all duration-300 hover:scale-110"
            ...
            <div className="mt-3">
              <p className="text-[13px] text-[#9aa0a9] mb-2 font-light">
              ...
              <div className="flex gap-2">
                <input 
                  ...
                  className="flex-1 px-4 py-2 bg-white border border-gray-200 rounded-full text-[14px] text-[#1a1a2e] focus:outline-none focus:border-[#005af0] transition-all"
                  style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}
                />
                <button 
                  className="px-5 py-2 bg-[#005af0] text-white rounded-full text-[14px] font-medium hover:bg-[#0045c7] transition-all hover:scale-105 whitespace-nowrap"
                  style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}
                >
                  Subscribe
                </button>
        ...
        <div className="border-t border-gray-200/60 mt-10 pt-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-3">
            <p 
              className="text-[13px] text-[#9aa0a9] font-light"
              style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}
            >
            ...
            <div className="flex gap-6 text-[13px]">
              <a href="#" className="text-[#9aa0a9] hover:text-[#005af0] transition-colors font-light">
                Privacy Policy
              </a>
              <a href="#" className="text-[#9aa0a9] hover:text-[#005af0] transition-colors font-light">
                Terms of Service
