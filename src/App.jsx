...
function Footer({ setView, currentView = 'home' }) {
  ...
  const theme = isDark ? {
    ...
    logoColor: 'text-[#4a4a6a]',
    linkColor: 'text-gray-400',
    linkHover: 'text-[#6c63ff]',
    ...
    logoColor: 'text-[#adb5bd]',
    linkColor: 'text-gray-600',
    linkHover: 'text-[#005af0]',
  ...
  return (
    <footer 
      className={`w-full ${theme.bg} pt-16 pb-8 border-t ${theme.border} transition-all duration-500`}
      style={{ 
        opacity: 1, 
        transform: 'scale(1)',
    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        ...
        <div className="flex justify-end mb-4">
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-bold transition-all duration-300 hover:scale-105 ${
              isDark 
                ? 'bg-[#1a1a2e] text-yellow-400 hover:bg-[#2a2a4e]' 
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-16">
          ...
          {/* BRANDING SECTION */}
          <div className="flex-1">
            <h1 className={`text-[46px] font-black tracking-tighter ${theme.logoColor} leading-none mb-3 lowercase transition-colors duration-300`}>
              zippy
            </h1>
            <p 
              className={`text-[14px] md:text-[16px] font-medium ${theme.text} flex items-center justify-start tracking-tight transition-colors duration-300`}
            ...
            <p className={`text-[13px] ${theme.textMuted} tracking-wide font-light transition-colors duration-300`}>
          ...
          {/* QUICK LINKS SECTION */}
          <div className="flex-1">
            <h4 className={`font-black ${theme.textMuted} mb-5 uppercase tracking-widest text-[11px] transition-colors duration-300`}>
              Quick Links
            </h4>
              ...
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <button 
                    ...
                    className={`text-[14px] font-bold ${theme.linkColor} transition-all duration-300 cursor-pointer bg-transparent border-none p-0 text-left group flex items-center gap-2 ${
          ...
          <div className="flex-[1.5]">
            ...
            <div className="flex gap-3 mb-6">
              ...
              <a href="https://www.instagram.com/_s.a.t.y.a.m.m_/" target="_blank" rel="noreferrer" 
                className={`w-10 h-10 ${theme.iconBg} ${theme.iconText} rounded-full flex items-center justify-center hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-600 hover:text-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300`}>
              ...
              <a href="https://facebook.com/your_id" target="_blank" rel="noreferrer" 
                className={`w-10 h-10 ${theme.iconBg} ${theme.iconText} rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300`}>
              ...
              <a href="https://twitter.com/your_id" target="_blank" rel="noreferrer" 
                className={`w-10 h-10 ${theme.iconBg} ${theme.iconText} rounded-full flex items-center justify-center hover:bg-black hover:text-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300`}>
              ...
              <a href="https://www.youtube.com/channel/UC27JTGeeqX4ZxROqmyuhypQ/posts?pvf=CAI%253D" target="_blank" rel="noreferrer" 
                className={`w-10 h-10 ${theme.iconBg} ${theme.iconText} rounded-full flex items-center justify-center hover:bg-red-600 hover:text-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300`}>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
            </div>

            <p className={`text-[13px] font-bold ${theme.linkColor} mb-3 transition-colors duration-300`}>
            ...
            <form className="flex gap-2 w-full max-w-[380px]" onSubmit={handleSubscribe}>
              <input 
                ...
                className={`flex-1 ${theme.inputBg} border ${theme.inputBorder} px-5 py-2.5 rounded-[2rem] text-sm font-bold ${theme.inputText} focus:outline-none focus:border-[#005af0] focus:ring-2 focus:ring-[#005af0]/20 transition-all duration-300 shadow-sm placeholder-gray-400`}
              />
              <button 
                type="submit" 
        ...
        {/* BOTTOM LEGAL BAR */}
        <div className={`pt-6 border-t ${theme.divider} flex flex-col md:flex-row justify-between items-center gap-4 text-[12px] font-bold ${theme.textMuted} transition-colors duration-300`}>
          <p>© 2026 Zippy Cafe. All rights reserved.</p>
          <div className="flex gap-6">
            <a href="#" onClick={(e) => e.preventDefault()} className={`hover:${isDark ? 'text-gray-300' : 'text-gray-800'} transition-colors`}>
              Privacy Policy
            </a>
            <a href="#" onClick={(e) => e.preventDefault()} className={`hover:${isDark ? 'text-gray-300' : 'text-gray-800'} transition-colors`}>
              Terms of Service
